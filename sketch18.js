...
function preload() {
  ...
  airplane = loadImage ('airplanehome.png');
...
function setup() {
  ...
  var points = font.textToPoints('Bye Berlin!!', 370, 300, 100, {
    sampleFactor: 0.25
  });
        ...
        if (mouseIsPressed)
{
  ...
  text("(thank u for joining along the journey :-))", 910, 450);
